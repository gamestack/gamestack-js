window.SearcherDisplay = (function($) {
    ...
    //FILE MODIFIED to alter navbar / Show main image

    window.setTimeout(function(){

        $('a.navbar-brand').html('<img border="0" alt="Gamestack.js-logo" src="assets/image/gamestack-logo.png" height="120%;" width="auto"  >');
